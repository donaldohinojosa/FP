Algoritmo OpcionesDePeliculas
	...
	Escribir "Ingrese un número del 0 - 4"
	leer pelicula
	...
	SiNo
		Si (pelicula==1) Entonces
			Escribir "Harry Potter Y La Cámara Secret"
		SiNo
			Si (pelicula==2) Entonces
				Escribir "Harry Potter Y El Prisionero de Azkaban"
			SiNo
				Si (pelicula==3) Entonces
					Escribir "Harry Potter Y El Cáliz de Fuego"
				SiNo
					Si (pelicula==4) Entonces
						Escribir "Harry Potter Y La Orden del Fénix"
					SiNo
